...
export class RefillMoneyUseCase {
  public constructor(
  ...
  public async refill(bankAccountId: string, sum: number): Promise<IBankAccount | void> {
    return this._bankAccountRepository.refillMoney({ bankAccountId, sum })
      .then((value) => {
